...
The action also uploads `endpoint-report.csv`, a per-endpoint report of passing endpoints with model size, provider, quantization, cacheability, latency, and throughput.
